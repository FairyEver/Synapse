...
诊断服务检查系统进程、应用版本、临时目录写入、仓库路径、项目路径、日志文件、近期日志、启动与重启信号、Windows 兼容日志、Database 状态、Database 完整性、Database CLI、Database MCP、服务注册表、DataRepository 和连接器运行状态。此外，渲染进程追加一次 Renderer-Main IPC 往返检查。
