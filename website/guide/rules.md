...
Rule 是一段可复用的 Markdown 正文，不包含附件。适合保存行为约束、输出格式、审查清单和安全边界。

## 浏览与搜索

Rule 位于资源仓库 App。页面支持按分类浏览、关键词搜索、收藏、最近浏览、最近删除和版本查看。

## 下载

Rule 下载为 `.md` 文件，仅包含当前版本正文。
...
需要附件、模板或脚本时，使用 [Skill](/guide/skills)。
