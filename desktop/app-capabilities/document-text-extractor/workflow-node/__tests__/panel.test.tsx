...
import { DocumentTextExtractNodePanel } from "../panel"

vi.mock("@/lib/ui-tracking", () => ({ track: vi.fn() }))

globalThis.IS_REACT_ACT_ENVIRONMENT = true

describe("DocumentTextExtractNodePanel", () => {
  it("edits the document path and keeps existing variable bindings", () => {
    ...
    const input = container.querySelector<HTMLInputElement>("#document-text-extract-node-file")
