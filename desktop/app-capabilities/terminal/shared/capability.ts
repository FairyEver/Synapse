...
export const TERMINAL_CAPABILITY_CATALOG = [
  ...
  C({ id: "app.terminal.global_launch.get", title: "Get global terminal launch settings", description: "Read global launch keys, actions, sources, and revision without environment values.", mutates: false, risk: "high", permissions: ["metadata.read"] }),
  C({ id: "app.terminal.global_launch.update", title: "Update global terminal launch settings", description: "Update global launch settings with revision conflict protection.", mutates: true, risk: "high", permissions: ["settings.manage"] }),
  ...
  C({ id: "app.terminal.group_launch.get", title: "Get terminal launch settings", description: "Read group Shell, cwd, environment keys, actions, sources, and launch revision without environment values.", mutates: false, risk: "high", permissions: ["metadata.read"] }),
  ...
  C({ id: "app.terminal.session_state.list", title: "List terminal session states", description: "List bounded lifecycle, attention, lease occupancy, watermarks, the PTY device, and the agent's own run state without output text.", mutates: false, risk: "normal", permissions: ["discover", "state.read"] }),
  C({ id: "app.terminal.session_state.get", title: "Get terminal session state", description: "Read lifecycle, attention, visible lease state, watermarks, the PTY device, and the agent's own run state without output text.", mutates: false, risk: "normal", permissions: ["state.read"] }),
  ...
  C({ id: "app.terminal.session_metadata.rename", title: "Rename terminal session", description: "Rename a Terminal session with metadata revision protection; a session that is its workspace's only terminal renames the workspace with it.", mutates: true, risk: "normal", permissions: ["metadata.manage"] }),
