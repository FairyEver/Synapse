...
- App-provided capabilities such as document text extraction, document generation, Synapse-managed Terminal sessions, and Sound Notifier playback -> `app/index.md`
