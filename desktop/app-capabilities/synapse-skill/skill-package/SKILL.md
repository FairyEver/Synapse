...
- Synapse Desktop update checks, update installation, full desktop restart, account sign-in state and signing the desktop client back in, Synapse Agent conversation deep links, conversation creation, provider/model discovery and group discovery, plus other App-provided capabilities such as text file writing, text extraction, document generation, JSON repair, Sound Notifier playback, System Notifier notifications, and problem feedback -> `app/index.md`
