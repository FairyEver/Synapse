...
- Synapse-managed Terminal launch settings, groups, saved commands, sessions, opening a session from its deep link, retained output, observation, leases, semantic input, resize, stop, and deletion -> `terminal/index.md`
