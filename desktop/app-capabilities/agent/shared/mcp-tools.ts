...
const toolNotes: Readonly<Record<string, string>> = {
  ...
  "app.agent.conversation.inspect": "For the first read, pass the complete deepLink unchanged. Use the returned conversationRef for pagination and follow-up calls. Results are redacted and bounded to 100 timeline entries, 64 KiB per entry, and 1 MiB per page.",
