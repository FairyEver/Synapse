...
describe("createAppCapabilityDispatcher", () => {
  it("routes document template and screenshot actions to their dispatchers", async () => {
    ...
    const dispatcher = createAppCapabilityDispatcher({ documentTemplate, screenshot })
