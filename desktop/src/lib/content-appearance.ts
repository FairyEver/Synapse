...
const SYNAPSE_CONTENT_COLOR_OPTIONS: SynapseContentColorOption[] = [
  ...
  },
  {
    value: "red",
    label: "赤红",
    backgroundClassName: "bg-destructive/20",
    foregroundClassName: "text-destructive",
  },
  {
    value: "orange",
    label: "橙黄",
    backgroundClassName: "bg-accent/30",
    foregroundClassName: "text-accent-foreground",
  },
  {
    value: "amber",
    label: "琥珀",
    backgroundClassName: "bg-accent/60",
    foregroundClassName: "text-accent-foreground",
  },
  {
    value: "green",
  ...
  },
  {
    value: "teal",
    label: "青绿",
    backgroundClassName: "bg-secondary/60",
    foregroundClassName: "text-secondary-foreground",
  },
  {
    value: "blue",
    label: "海蓝",
    backgroundClassName: "bg-secondary/80",
    foregroundClassName: "text-secondary-foreground",
  },
  {
    value: "indigo",
    label: "靛蓝",
    backgroundClassName: "bg-accent/80",
    foregroundClassName: "text-accent-foreground",
  },
]
...
const SYNAPSE_LEGACY_CONTENT_COLOR_OPTIONS: SynapseContentColorOption[] = [
  {
    value: "rose",
    label: "莓红",
    backgroundClassName: "bg-destructive/15",
    foregroundClassName: "text-destructive",
  },
  {
    value: "lime",
  ...
  },
  {
    value: "cyan",
    label: "湖蓝",
    backgroundClassName: "bg-accent/40",
    foregroundClassName: "text-accent-foreground",
  },
]
