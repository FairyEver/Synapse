...
describe("AgentComposer", () => {
  it("renders a lightweight borderless input bar with an icon-only send button", () => {
    ...
    expect(html).toContain("gap-2 rounded-full bg-muted/50")
    ...
    expect(html).not.toContain("gap-2 rounded-2xl bg-muted/50")
