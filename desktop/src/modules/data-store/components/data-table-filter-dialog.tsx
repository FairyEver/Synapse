...
type DraftCondition = {
  id: string
  field: string
  op: DataStoreWhereCondition["op"]
  value: string | boolean
}

const TEXT_OPERATORS: Array<{ value: DataStoreWhereCondition["op"]; label: string }> = [
  { value: "=", label: "等于" },
  { value: "!=", label: "不等于" },
  { value: "LIKE", label: "包含" },
]

const NUMBER_OPERATORS: Array<{ value: DataStoreWhereCondition["op"]; label: string }> = [
  { value: "=", label: "等于" },
  { value: "!=", label: "不等于" },
  { value: ">", label: "大于" },
  { value: ">=", label: "大于等于" },
...
const BOOLEAN_OPERATORS: Array<{ value: DataStoreWhereCondition["op"]; label: string }> = [
  { value: "=", label: "等于" },
  { value: "!=", label: "不等于" },
]
...
function DataTableFilterDialog({
  ...
  const [combinator, setCombinator] = useState<DataStoreWhereGroup["combinator"]>(DEFAULT_COMBINATOR)
                    ...
                    onValueChange={(op) => {
                      setConditions((current) => current.map((item) => (
                        item.id === condition.id
                          ? { ...item, op: op as DataStoreWhereCondition["op"] }
                          : item
                      )))
                    }}
                  >
