...
describe("AppsModule", () => {
  ...
  it("renders the fixed system apps without management controls", async () => {
    ...
    expect(document.body.textContent).toContain("Agent 会话")
    expect(document.body.textContent).toContain("流程编排")
    expect(document.body.textContent).toContain("文件与分享")
    expect(document.body.textContent).toContain("触发器与运行")
    expect(document.body.textContent).toContain("系统应用")
    expect(document.body.textContent).toContain("系统配置")
