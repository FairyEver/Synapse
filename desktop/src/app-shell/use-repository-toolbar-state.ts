...
function useRepositoryToolbarState({
  hasBlockingModalOpen,
}: {
  hasBlockingModalOpen: boolean
}): RepositoryToolbarState {
  ...
  return useMemo(() => {
    const runningOperation: RunningRepositoryOperation | null = activeRepositoryOperation?.isRunning
...
export type { RepositoryToolbarState }
export { useRepositoryToolbarState }
