...
type RepositoryToolbarActionsProps = {
...
function RepositoryToolbarActions({
...
export { RepositoryToolbarActions }
export type { RepositoryToolbarActionsProps }
