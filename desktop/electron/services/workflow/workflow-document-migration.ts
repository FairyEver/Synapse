...
const workflowMigrations: DataMigrationRegistry<VersionedWorkflowDefinition> = {
  ...
  "2.1.0": migrateWorkflowV2ToV2_1,
  "2.2.0": migrateWorkflowV2_1ToV2_2,
  "2.3.0": migrateWorkflowV2_2ToV2_3,
  "2.4.0": migrateWorkflowV2_3ToV2_4,
...
function migrateWorkflowV2ToV2_1(source: VersionedWorkflowDefinition): VersionedWorkflowDefinition {
  return source
}

function migrateWorkflowV2_1ToV2_2(source: VersionedWorkflowDefinition): VersionedWorkflowDefinition {
  return source
}

function migrateWorkflowV2_2ToV2_3(source: VersionedWorkflowDefinition): VersionedWorkflowDefinition {
  return source
}

function migrateWorkflowV2_3ToV2_4(source: VersionedWorkflowDefinition): VersionedWorkflowDefinition {
  return source
}

function migrateWorkflowV2_4ToV2_5(source: VersionedWorkflowDefinition): VersionedWorkflowDefinition {
  return source
}

function migrateWorkflowV2_5ToV2_6(source: VersionedWorkflowDefinition): VersionedWorkflowDefinition {
  return source
}

function migrateWorkflowV2_6ToV2_7(source: VersionedWorkflowDefinition): VersionedWorkflowDefinition {
  return source
}
