...
export function createProviderDraft(input: ProviderInput): ProviderDraft {
...
export function resolveProjectProviders(
...
export function convertCCSwitchProvider(row: CCSwitchProviderRow): ProviderDraft {
  let parsed: unknown
