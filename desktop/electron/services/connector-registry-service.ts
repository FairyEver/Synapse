...
const CC_CONNECTOR_DESCRIPTORS: SynapseConnectorDescriptor[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { name: "corp_id", kind: "string", required: true },
      { name: "corp_secret", kind: "secret", required: true },
      { name: "agent_id", kind: "string", required: true },
      { name: "callback_token", kind: "secret", required: true },
      { name: "callback_aes_key", kind: "secret", required: true },
      { name: "bot_id", kind: "string" },
      { name: "bot_secret", kind: "secret" },
      { name: "port", kind: "string", required: true, defaultValue: "8081" },
  ...
  },
  {
    ...
    options: [
      ...
      { name: "ilink_user_id", kind: "string" },
  ...
  },
  {
    ...
    transport: "websocket",
    options: [
      { name: "ws_url", kind: "string", required: true },
