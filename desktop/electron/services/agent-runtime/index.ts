  ...
  return {
    ...
    async create(ctx) {
      ...
      const service = new AgentRuntimeService({
        ...
        fileCheckpointEntries: ctx.dataRepo.namespace<AgentFileCheckpointEntryV1>("agent.file-checkpoints"),
        agentUsage: ctx.dataRepo.namespace<AgentUsageEntryV1>("agent.usage"),
        taskProgress: ctx.dataRepo.namespace<AgentTaskProgressEntryV1>("agent.task-progress"),
        agentArtifactStore,
        attachmentStagingService,
