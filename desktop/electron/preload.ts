...
const synapseBridge: SynapseBridge = {
  ...
  swarmTask: {
    ...
    deleteTask: (input) => invoke(IPC_CHANNELS.swarmTask.deleteTask)(input),
    startRun: (input) => invoke(IPC_CHANNELS.swarmTask.startRun)(input),
    stopRefill: (input) => invoke(IPC_CHANNELS.swarmTask.stopRefill)(input),
    cancelRun: (input) => invoke(IPC_CHANNELS.swarmTask.cancelRun)(input),
    listRuns: (input = {}) => invoke(IPC_CHANNELS.swarmTask.listRuns)(input),
    getRun: (input) => invoke(IPC_CHANNELS.swarmTask.getRun)(input),
