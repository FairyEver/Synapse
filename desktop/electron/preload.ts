...
const synapseBridge: SynapseBridge = {
  ...
  terminal: {
    ...
    pane: {
      ...
      equalize: (input) => invoke(IPC_CHANNELS.terminal.equalizePane)(input),
  ...
  live: {
    getDeviceSettings: invoke(IPC_CHANNELS.live.getDeviceSettings),
    setDeviceName: invoke(IPC_CHANNELS.live.setDeviceName),
  ...
  agent: {
    ...
    confirmFileCheckpointRewind: (args) => invoke(IPC_CHANNELS.agent.confirmFileCheckpointRewind)(args),
