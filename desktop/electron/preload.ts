...
const synapseBridge: SynapseBridge = {
  ...
  dataStore: {
    ...
    exportTable: (table) => invoke(DATA_STORE_CHANNELS.exportTable)(table),
    inspectTableImport: invoke(DATA_STORE_CHANNELS.inspectTableImport),
    importTable: (sourcePath) => invoke(DATA_STORE_CHANNELS.importTable)(sourcePath),
  ...
  connectors: {
    feishu: {
      ...
      listAllScheduledJobs: () =>
        invoke(IPC_CHANNELS.connectors.feishuListAllScheduledJobs)(),
      ...
      listAllHeartbeats: () =>
        invoke(IPC_CHANNELS.connectors.feishuListAllHeartbeats)(),
      ...
      deleteHeartbeat: (payload) =>
        invoke(IPC_CHANNELS.connectors.feishuDeleteHeartbeat)(payload),
