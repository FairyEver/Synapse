...
const synapseBridge: SynapseBridge = {
  ...
  config: {
    ...
    getCcConnectSettings: invoke(IPC_CHANNELS.config.getCcConnectSettings),
    updateCcConnectSettings: (payload) => invoke(IPC_CHANNELS.config.updateCcConnectSettings)(payload),
    getCcConnectRawConfig: invoke(IPC_CHANNELS.config.getCcConnectRawConfig),
    getCcConnectDiagnostics: invoke(IPC_CHANNELS.config.getCcConnectDiagnostics),
    reloadCcConnectConfig: invoke(IPC_CHANNELS.config.reloadCcConnectConfig),
    restartCcConnect: (payload) => invoke(IPC_CHANNELS.config.restartCcConnect)(payload),
  ...
  automation: {
    ...
    listHeartbeat: () => invoke(IPC_CHANNELS.automation.listHeartbeat)(),
    upsertHeartbeat: (payload) => invoke(IPC_CHANNELS.automation.upsertHeartbeat)(payload),
    pauseHeartbeat: (payload) => invoke(IPC_CHANNELS.automation.pauseHeartbeat)(payload),
    resumeHeartbeat: (payload) => invoke(IPC_CHANNELS.automation.resumeHeartbeat)(payload),
    setHeartbeatInterval: (payload) => invoke(IPC_CHANNELS.automation.setHeartbeatInterval)(payload),
    triggerHeartbeat: (payload) => invoke(IPC_CHANNELS.automation.triggerHeartbeat)(payload),
    listHooks: (payload) => invoke(IPC_CHANNELS.automation.listHooks)(payload),
    createHook: (payload) => invoke(IPC_CHANNELS.automation.createHook)(payload),
    updateHook: (payload) => invoke(IPC_CHANNELS.automation.updateHook)(payload),
    deleteHook: (payload) => invoke(IPC_CHANNELS.automation.deleteHook)(payload),
    testHook: (payload) => invoke(IPC_CHANNELS.automation.testHook)(payload),
  },
  dataStore: {
