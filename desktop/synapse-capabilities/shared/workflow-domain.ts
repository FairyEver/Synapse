        ...
        properties: {
          ...
          config: {
            ...
            properties: {
              ...
              paramTemplates: { type: "object", description: "workflow_call only: child text/number/option parameter name to template string map." },
