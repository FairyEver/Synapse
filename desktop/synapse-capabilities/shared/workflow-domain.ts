...
export function buildWorkflowTools(): McpToolDefinition[] {
  return withPrimaryMcpTools([
    ...
    },
    {
      ...
      inputSchema: {
        type: "object",
        properties: { nodeType: { type: "string", description: "Node type identifier (e.g. \"text\", \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"text_extract\", \"file_opener_file_open\", \"text_file_writer_file_write\", \"html_generator_ejs_generate\", \"html_generator_ejs_file_generate\", \"json_repair_text_repair\", \"system_notifier_notification_trigger\", \"clipboard_text_write\", \"clipboard_text_read\", \"javascript_run\", \"nodejs_run\", \"codex\", \"claude_code\", \"end\")." } },
        required: ["nodeType"],
      },
    },
    // Read
        ...
        properties: {
          ...
          node: {
            ...
            properties: {
              ...
              type: { type: "string", description: "Node type (e.g. \"text\", \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"text_extract\", \"file_opener_file_open\", \"text_file_writer_file_write\", \"html_generator_ejs_generate\", \"html_generator_ejs_file_generate\", \"json_repair_text_repair\", \"system_notifier_notification_trigger\", \"clipboard_text_write\", \"clipboard_text_read\", \"javascript_run\", \"nodejs_run\", \"codex\", \"claude_code\", \"end\")." },
