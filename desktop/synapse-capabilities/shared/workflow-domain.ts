...
const workflowCapabilities: readonly CapabilityDefinition[] = [
  ...
  { id: "app.workflow.definition.delete" as CapabilityId, title: "Delete workflow", description: "Delete a workflow, including a protected future-schema or migration-failed document, cancel active runs, and clean up snapshots. Deletion is blocked while another workflow_call still references it.", mutates: true },
  // Execute
        ...
        properties: {
          ...
          config: {
            ...
            properties: {
              ...
              template: { type: "string", description: "text/end or HTML Generator only. Text/end use {{variable}} interpolation. HTML Generator requires non-empty executable EJS and never applies Workflow interpolation." },
              ...
              outputPath: { type: "string", description: "document_template_docx_generate or html_generator_ejs_file_generate output path. Supports declared {{variable}} interpolation; HTML Generator excludes its data binding." },
              ...
              overwrite: { type: "boolean", default: false, description: "document_template_docx_generate/text_file_writer_file_write/html_generator_ejs_file_generate: whether an existing output file may be replaced." },
              filePath: { type: "string", description: "text_extract only: absolute local PDF or DOCX path. Supports {{variable}} interpolation." },
              path: { type: "string", description: "file_opener_file_open/text_file_writer_file_write: absolute local path. The writer accepts any extension or no extension. Supports {{variable}} interpolation." },
...
export function buildWorkflowTools(): McpToolDefinition[] {
  return withPrimaryMcpTools([
    // Discovery
    {
      ...
      description: `${SYSTEM_MODEL_DESCRIPTION} ${TEXT_FILE_WRITER_WORKFLOW_GUIDANCE} ${HTML_GENERATOR_WORKFLOW_GUIDANCE}`,
    ...
    },
    {
      ...
      inputSchema: {
        type: "object",
        properties: { nodeType: { type: "string", description: "Node type identifier (e.g. \"text\", \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"text_extract\", \"file_opener_file_open\", \"text_file_writer_file_write\", \"html_generator_ejs_generate\", \"html_generator_ejs_file_generate\", \"codex\", \"claude_code\", \"end\")." } },
        required: ["nodeType"],
      },
    },
    // Read
        ...
        properties: {
          ...
          node: {
            ...
            properties: {
              ...
              type: { type: "string", description: "Node type (e.g. \"text\", \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"text_extract\", \"file_opener_file_open\", \"text_file_writer_file_write\", \"html_generator_ejs_generate\", \"html_generator_ejs_file_generate\", \"codex\", \"claude_code\", \"end\")." },
