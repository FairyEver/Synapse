...
export function buildWorkflowTools(): McpToolDefinition[] {
  return withPrimaryMcpTools([
    ...
    },
    {
      ...
      inputSchema: {
        type: "object",
        properties: { nodeType: { type: "string", description: "Node type identifier (e.g. \"text\", \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"codex\", \"claude_code\", \"end\")." } },
        required: ["nodeType"],
      },
    },
    // Read
        ...
        properties: {
          ...
          node: {
            ...
            properties: {
              ...
              type: { type: "string", description: "Node type (e.g. \"text\", \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"codex\", \"claude_code\", \"end\")." },
