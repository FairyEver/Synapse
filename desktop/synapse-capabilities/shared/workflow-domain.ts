        ...
        properties: {
          ...
          config: {
            ...
            properties: {
              ...
              filePath: { type: "string", description: "text_extract only: absolute local PDF or DOCX file path. Supports {{variable}} interpolation." },
...
export function buildWorkflowTools(): McpToolDefinition[] {
  return withPrimaryMcpTools([
    ...
    },
    {
      ...
      inputSchema: {
        type: "object",
        properties: { nodeType: { type: "string", description: "Node type identifier (e.g. \"text\", \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"text_extract\", \"codex\", \"claude_code\", \"end\")." } },
        required: ["nodeType"],
      },
    },
    // Read
        ...
        properties: {
          ...
          node: {
            ...
            properties: {
              ...
              type: { type: "string", description: "Node type (e.g. \"text\", \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"text_extract\", \"codex\", \"claude_code\", \"end\")." },
