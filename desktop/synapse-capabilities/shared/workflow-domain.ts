        ...
        properties: {
          ...
          config: {
            ...
            properties: {
              ...
              taskId: { type: "string", description: "swarm_task_run only: saved Swarm Task ID." },
              promptOverride: { type: "string", description: "swarm_task_run only: optional prompt override for this run. Supports {{variable}} interpolation." },
              runModeOverride: { type: "string", enum: ["batch", "continuous"], description: "swarm_task_run only: optional run mode override." },
              maxRoundsOverride: { type: "number", minimum: 1, maximum: 500, description: "swarm_task_run only: optional round-count override." },
              concurrencyOverride: { type: "number", minimum: 1, maximum: 20, description: "swarm_task_run only: optional concurrency override." },
              waitForCompletion: { type: "boolean", default: false, description: "swarm_task_run only: wait for a terminal run result instead of returning immediately." },
...
export function buildWorkflowTools(): McpToolDefinition[] {
  return withPrimaryAndLegacyMcpTools([
    ...
    },
    {
      ...
      inputSchema: {
        type: "object",
        properties: { nodeType: { type: "string", description: "Node type identifier (e.g. \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"swarm_task_run\", \"codex\", \"claude_code\", \"end\")." } },
        required: ["nodeType"],
      },
    },
    // Read
        ...
        properties: {
          ...
          node: {
            ...
            properties: {
              ...
              type: { type: "string", description: "Node type (e.g. \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"swarm_task_run\", \"codex\", \"claude_code\", \"end\")." },
