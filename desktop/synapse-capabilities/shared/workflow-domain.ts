        ...
        properties: {
          ...
          config: {
            ...
            properties: {
              ...
              template: { type: "string", description: "text/end only: output template. The text node accepts an empty string and preserves whitespace exactly." },
              ...
              filePath: { type: "string", description: "text_extract/open_file only: absolute local file path. text_extract accepts PDF or DOCX; open_file requires an existing non-symbolic-link regular file and rejects URLs and directories. Supports {{variable}} interpolation." },
...
export function buildWorkflowTools(): McpToolDefinition[] {
  return withPrimaryMcpTools([
    ...
    },
    {
      ...
      inputSchema: {
        type: "object",
        properties: { nodeType: { type: "string", description: "Node type identifier (e.g. \"text\", \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"text_extract\", \"open_file\", \"codex\", \"claude_code\", \"end\")." } },
        required: ["nodeType"],
      },
    },
    // Read
        ...
        properties: {
          ...
          node: {
            ...
            properties: {
              ...
              type: { type: "string", description: "Node type (e.g. \"text\", \"prompt\", \"switch\", \"http_request\", \"script\", \"workflow_call\", \"document_template_docx_generate\", \"text_extract\", \"open_file\", \"codex\", \"claude_code\", \"end\")." },
