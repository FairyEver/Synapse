...
**Could be a separate plugin** rather than bundled into Synapse Knowledge Base.
...
**Note**: kepano already published skills in Agent Skills format — Synapse Knowledge Base is already in that format. Just needs the adapter files.
...
After this research, Synapse Knowledge Base's unique advantages remain:
