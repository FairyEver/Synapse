---
type: session
title: "Synapse Knowledge Base v1.2.0 Release Session"
created: 2026-04-07
updated: 2026-04-07
tags:
  - session
...
Full build, audit, polish, and community release of the Synapse Knowledge Base plugin + vault kit. Previously named `cosmic-brain`.
...
## Rename: cosmic-brain → Synapse Knowledge Base

Full project rename executed:
- GitHub repos renamed: `AgriciDaniel/cosmic-brain` → `AgriciDaniel/Synapse Knowledge Base` (public), `avalonreset-pro/cosmic-brain` → `avalonreset-pro/Synapse Knowledge Base` (private)
- Local directory: `~/cosmic-brain/` → `~/Synapse Knowledge Base/`
- All text references updated across 14 files via sed
- `wiki/meta/cosmic-brain-cover.gif` renamed to `wiki/meta/Synapse Knowledge Base-cover.gif`
...
1. `Synapse Knowledge Base-gif-cover-16x9.gif` — header
2. Description text
...
| Repo | Visibility | URL |
|------|-----------|-----|
| AgriciDaniel/Synapse Knowledge Base | Public | https://github.com/AgriciDaniel/Synapse Knowledge Base |
| avalonreset-pro/Synapse Knowledge Base | Private | https://github.com/avalonreset-pro/Synapse Knowledge Base |

Community install command: `claude plugin install github:AgriciDaniel/Synapse Knowledge Base`
...
- **Rename to Synapse Knowledge Base**: clearer branding, immediately communicates the Synapse Knowledge Base pairing
