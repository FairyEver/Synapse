...
## Relevance to Synapse Knowledge Base
Claudian is a native plugin (different category) but its Plan Mode, @mention, and inline edit patterns could inspire new features in Synapse Knowledge Base skills — particularly for the canvas and wiki-query workflows.
