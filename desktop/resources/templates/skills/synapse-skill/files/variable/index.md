...
You have access to Synapse Variable MCP tools for managing user-scoped local variables used by `${{ NAME }}` placeholders.
...
7. Use `variable_item_delete` only after the variable name is clear.
