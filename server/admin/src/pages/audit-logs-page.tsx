...
export const AUDIT_ACTION_FILTER_OPTIONS = [
  ...
  { value: "user.auth.verify.failed", label: "user.auth.verify.failed" },
  ...
  { value: "admin.user.status_update.failed", label: "admin.user.status_update.failed" },
  { value: "admin.team_entitlements.update", label: "admin.team_entitlements.update" },
  { value: "admin.team_entitlements.update.failed", label: "admin.team_entitlements.update.failed" },
  { value: "admin.team_permissions.update", label: "admin.team_permissions.update" },
  { value: "admin.team_permissions.update.failed", label: "admin.team_permissions.update.failed" },
  { value: "admin.team_role_permissions.update", label: "admin.team_role_permissions.update" },
  { value: "admin.team_role_permissions.update.failed", label: "admin.team_role_permissions.update.failed" },
  { value: "admin.team_member_access_roles.replace", label: "admin.team_member_access_roles.replace" },
  { value: "admin.team_member_access_roles.replace.failed", label: "admin.team_member_access_roles.replace.failed" },
  { value: "admin.team_member_access_role.assign", label: "admin.team_member_access_role.assign" },
  { value: "admin.team_member_access_role.assign.failed", label: "admin.team_member_access_role.assign.failed" },
  { value: "admin.team_member_access_role.remove", label: "admin.team_member_access_role.remove" },
  { value: "admin.team_member_access_role.remove.failed", label: "admin.team_member_access_role.remove.failed" },
  ...
  { value: "teams.auth.verify.failed", label: "teams.auth.verify.failed" },
  ...
  { value: "logs.list_files", label: "logs.list_files" },
  { value: "logs.recent", label: "logs.recent" },
