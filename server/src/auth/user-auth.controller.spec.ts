...
describe("UserAuthController", () => {
  it("applies stricter throttling to public auth endpoints", () => {
    ...
    expect(Reflect.getMetadata(throttleLimitMetadata, UserAuthController.prototype.login)).toBe(10)
    ...
    expect(Reflect.getMetadata(throttleLimitMetadata, UserAuthController.prototype.refresh)).toBe(60)
    expect(Reflect.getMetadata(throttleTtlMetadata, UserAuthController.prototype.refresh)).toBe(60000)
    expect(Reflect.getMetadata(throttleLimitMetadata, UserAuthController.prototype.logout)).toBe(60)
