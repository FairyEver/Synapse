...
界面文案是客观说明，不是在跟用户聊天。保持专业和易懂——**易懂不等于口语化**。

禁止：

- 口语化连接词 / 语气词："就"、"就会"、"再"、"其实"、"一下"、"啦"、"吧"、"呢"
- 引导式、陪聊式口吻："你会发现"、"好了"、"接下来"、"我们来…"、"跟着做"
- 指着屏幕说话的句子："这里就会显示出…"、"上面这个…"、"你看" —— 改用陈述句直接说结果或要求
- 安抚 / 客套："不用担心"、"别着急"、"随时"、"放心"
...
```
❌ 电脑不在线
   终端运行在电脑上。打开电脑上的 Synapse，并保持账号登录，
   这里就会显示出正在运行的终端。
...
反例的三个毛病：解释了终端跑在哪（用户不需要知道）、"就会显示出"是口语、三句话说了"打开并登录"一件事。
