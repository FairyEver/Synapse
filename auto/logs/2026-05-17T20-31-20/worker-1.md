...
{"type":"thread.started","thread_id":"019e37a2-de64-72c1-a626-d032cf300313"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37a2-de64-72c1-a626-d032cf300313"
}
```
{"type":"turn.started"}
...
2026-05-17T20:31:24.418467Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
