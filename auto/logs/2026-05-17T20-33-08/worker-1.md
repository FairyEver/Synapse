...
{"type":"thread.started","thread_id":"019e37a4-81c4-7f20-8ef0-f6aa7a0275b6"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37a4-81c4-7f20-8ef0-f6aa7a0275b6"
}
```
{"type":"turn.started"}
...
2026-05-17T20:33:12.219176Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
