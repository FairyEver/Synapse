...
{"type":"thread.started","thread_id":"019e37ea-de19-7823-a517-afc790c09135"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37ea-de19-7823-a517-afc790c09135"
}
```
{"type":"turn.started"}
...
2026-05-17T21:50:02.914430Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
...
---
**Duration:** 10.7s | **Status:** error | **Exit:** 1
