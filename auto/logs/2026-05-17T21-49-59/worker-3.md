...
{"type":"thread.started","thread_id":"019e37ea-de19-7d23-89f9-1ffcaddbe203"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37ea-de19-7d23-89f9-1ffcaddbe203"
}
```
{"type":"turn.started"}
...
2026-05-17T21:50:02.832438Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
...
---
**Duration:** 8.1s | **Status:** error | **Exit:** 1
