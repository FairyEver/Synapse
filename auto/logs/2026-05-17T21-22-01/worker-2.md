...
{"type":"thread.started","thread_id":"019e37d1-44bb-7fb1-b7e4-b3fad8874cf5"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37d1-44bb-7fb1-b7e4-b3fad8874cf5"
}
```
{"type":"turn.started"}
...
2026-05-17T21:22:05.936837Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
...
---
**Duration:** 9.3s | **Status:** error | **Exit:** 1
