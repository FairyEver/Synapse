...
{"type":"thread.started","thread_id":"019e37d4-70d1-76c2-b983-7c3207568880"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37d4-70d1-76c2-b983-7c3207568880"
}
```
{"type":"turn.started"}
...
2026-05-17T21:25:33.282700Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
