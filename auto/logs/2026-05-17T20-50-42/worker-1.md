...
{"type":"thread.started","thread_id":"019e37b4-95e2-7b11-a548-efd6a352c438"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37b4-95e2-7b11-a548-efd6a352c438"
}
```
{"type":"turn.started"}
...
2026-05-17T20:50:46.240554Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
...
---
**Duration:** 17.9s | **Status:** error | **Exit:** 1
