...
{"type":"thread.started","thread_id":"019e37b4-95de-7e33-8bd3-3dc719f75529"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37b4-95de-7e33-8bd3-3dc719f75529"
}
```
{"type":"turn.started"}
...
2026-05-17T20:50:44.956476Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
...
---
**Duration:** 17.5s | **Status:** error | **Exit:** 1
