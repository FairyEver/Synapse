...
{"type":"thread.started","thread_id":"019e37d2-7513-70a2-a42a-ffceb4513055"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37d2-7513-70a2-a42a-ffceb4513055"
}
```
{"type":"turn.started"}
...
2026-05-17T21:23:22.899010Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
...
---
**Duration:** 6.0s | **Status:** error | **Exit:** 1
