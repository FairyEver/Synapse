...
{"type":"thread.started","thread_id":"019e37b3-754c-7c71-97f7-aebe614a230b"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37b3-754c-7c71-97f7-aebe614a230b"
}
```
{"type":"turn.started"}
...
2026-05-17T20:49:32.594828Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
