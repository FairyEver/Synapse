...
{"type":"thread.started","thread_id":"019e37b7-f641-7b61-b7cd-4a49d10e3d4e"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37b7-f641-7b61-b7cd-4a49d10e3d4e"
}
```
{"type":"turn.started"}
...
2026-05-17T20:54:25.666228Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
