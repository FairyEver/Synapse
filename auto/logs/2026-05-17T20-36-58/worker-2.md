...
{"type":"thread.started","thread_id":"019e37a8-0305-7753-834a-d0433a97ca05"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37a8-0305-7753-834a-d0433a97ca05"
}
```
{"type":"turn.started"}
...
2026-05-17T20:37:01.476736Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
