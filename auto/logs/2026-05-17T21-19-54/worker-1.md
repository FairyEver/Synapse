...
{"type":"thread.started","thread_id":"019e37cf-53e8-70b0-8ed3-a9118a601f9a"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37cf-53e8-70b0-8ed3-a9118a601f9a"
}
```
{"type":"turn.started"}
...
2026-05-17T21:19:58.254998Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
