...
{"type":"thread.started","thread_id":"019e37c2-11ad-75c1-b4cd-c8cff917251e"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37c2-11ad-75c1-b4cd-c8cff917251e"
}
```
{"type":"turn.started"}
...
2026-05-17T21:05:29.474408Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
