...
{"type":"thread.started","thread_id":"019e37a7-762a-7000-a154-32fa18913fc6"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37a7-762a-7000-a154-32fa18913fc6"
}
```
{"type":"turn.started"}
...
2026-05-17T20:36:25.378494Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
