...
{"type":"thread.started","thread_id":"019e37a4-c3b1-7ef1-9e0f-367198a20a60"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37a4-c3b1-7ef1-9e0f-367198a20a60"
}
```
{"type":"turn.started"}
...
2026-05-17T20:33:28.285689Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
...
---
**Duration:** 6.1s | **Status:** error | **Exit:** 1
