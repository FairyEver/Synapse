...
{"type":"thread.started","thread_id":"019e37d9-b2a6-77a0-a503-6303fe8d6583"}


```json
{
  "type": "thread.started",
  "thread_id": "019e37d9-b2a6-77a0-a503-6303fe8d6583"
}
```
{"type":"turn.started"}
...
2026-05-17T21:31:17.728108Z ERROR rmcp::transport::worker: worker quit with fatal: Transport channel closed, when UnexpectedContentType(Some("missing-content-type; body: "))
...
---
**Duration:** 7.5s | **Status:** error | **Exit:** 1
