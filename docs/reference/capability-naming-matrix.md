...
Old public names are intentionally not aliases. Calls such as `listTables`, `list_tables`, `synapse tables`, `schedulerTaskRunsList`, and `scheduler_task_runs_list` should fail after this migration.
