  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="flex min-h-screen flex-col">
        <header className={cn("app-drag border-b border-border bg-card/85 backdrop-blur-sm", isMacOS && "pt-7")}>
        ...
        <div className="flex min-h-0 flex-1 flex-col lg:flex-row">
          <aside className="border-b border-border bg-card/55 lg:w-[290px] lg:shrink-0 lg:border-r lg:border-b-0">
            {sidebar}
          </aside>
