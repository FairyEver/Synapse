...
import { z } from 'zod'
import { ContentStoreListPage } from '@/features/content-store'
...
export const Route = createFileRoute('/_authenticated/content-store/')({
  beforeLoad: requireDashboardUser,
  validateSearch: searchSchema,
  component: () => <ContentStoreListPage search={Route.useSearch()} />,
})
